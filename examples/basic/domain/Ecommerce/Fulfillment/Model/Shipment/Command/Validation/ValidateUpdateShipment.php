...
use Ecommerce\Fulfillment\Model\Shipment\Command\UpdateShipment;
...
/**
 * Validates the CommandUpdateShipment command DTO graph.
 *
 ...
 */
class ValidateUpdateShipment extends EcommerceContext
{
    /**
     * Validates the command DTO.
     *
     * @param CommandUpdateShipment $dto Command DTO
     * @throws ValidationException If validation fails
     * @throws JsonException
     * @throws Throwable
     */
    public function __invoke(CommandUpdateShipment $dto): void
    {
        $registry = new ValidatorRegistry();
        $registry->register(UpdateShipment::class, ($this->handle(ShipmentValidator::class))());
