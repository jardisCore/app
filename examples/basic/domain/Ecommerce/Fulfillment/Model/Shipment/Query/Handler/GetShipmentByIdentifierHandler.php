...
/**
 * Query endpoint: GetShipmentByIdentifier
 */
class GetShipmentByIdentifierHandler extends EcommerceContext
{
    /**
    ...
    {
        /** @var QueryShipmentByIdentifier $shipmentByIdentifier */
        $shipmentByIdentifier = $this->payload();

        /** @var array<int, array<string, mixed>> $result */
        $result = $this->handle(ShipmentRepository::class)->getShipmentByIdentifier($shipmentByIdentifier, false);
