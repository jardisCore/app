...
namespace Ecommerce\Fulfillment\Model\Shipment\Query\Handler;

use Ecommerce\EcommerceContext;
use Ecommerce\Fulfillment\Model\Shipment\Query\Response\ShipmentResponse;
...
/**
 * Query endpoint: GetShipmentbyOrderNumber
 */
class GetShipmentbyOrderNumberHandler extends EcommerceContext
{
    /**
    ...
    {
        /** @var QueryShipmentbyOrderNumber $shipmentbyOrderNumber */
        $shipmentbyOrderNumber = $this->payload();

        /** @var array<int, array<string, mixed>> $result */
        $result = $this->handle(ShipmentRepository::class)->getShipmentbyOrderNumber($shipmentbyOrderNumber, false);
        ...
        $this->result()->setData(['shipment' => $projected[0] ?? null]);
