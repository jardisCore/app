...
/**
 * Root query class for Shipment (ByIdentifier variant).
 *
 * Loads the root entity. Follow-up queries are in QueryShipmentAdditions.
 * Generated code - do not modify directly.
 */
class QueryShipmentByIdentifier extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(ShipmentByIdentifierQuery $query): array
    {
        $this->container['shipment'] = $this->load(
            $this->shipment($query->identifier)
        );
     ...
     * @throws Throwable
     */
    protected function shipment(string $identifier): DbQueryBuilderInterface
    {
