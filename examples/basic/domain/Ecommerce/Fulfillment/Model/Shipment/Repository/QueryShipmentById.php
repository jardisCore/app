...
/**
 * Root query class for Shipment (ById variant).
 *
 * Loads the root entity. Follow-up queries are in QueryShipmentAdditions.
 * Generated code - do not modify directly.
 */
class QueryShipmentById extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(ShipmentByIdQuery $query): array
    {
        $this->container['shipment'] = $this->load(
            $this->shipment($query->id)
        );
     ...
     * @throws Throwable
     */
    protected function shipment(int $id): DbQueryBuilderInterface
    {
