...
use Throwable;
use Ecommerce\Catalog\Model\Product\Query\ProductByIdentifier as ProductByIdentifierQuery;
use Ecommerce\Catalog\Entity\Product as ProductEntity;

/**
 * Root query class for Product (ByIdentifier variant).
 *
 * Loads the root entity. Follow-up queries are in QueryProductAdditions.
 * Generated code - do not modify directly.
 */
class QueryProductByIdentifier extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(ProductByIdentifierQuery $query): array
    {
        $this->container['product'] = $this->load(
            $this->product($query->identifier)
        );
     ...
     * @throws Throwable
     */
    protected function product(string $identifier): DbQueryBuilderInterface
    {
