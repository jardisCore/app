...
/**
 * Root query class for Product (ById variant).
 *
 * Loads the root entity. Follow-up queries are in QueryProductAdditions.
 * Generated code - do not modify directly.
 */
class QueryProductById extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(ProductByIdQuery $query): array
    {
     ...
     * @throws Throwable
     */
    protected function product(int $id): DbQueryBuilderInterface
    {
