...
/**
 * Query endpoint: GetProductById
 */
class GetProductByIdHandler extends EcommerceContext
{
    /**
    ...
    {
        /** @var QueryProductById $productById */
        $productById = $this->payload();

        /** @var array<int, array<string, mixed>> $result */
        $result = $this->handle(ProductRepository::class)->getProductById($productById, false);
