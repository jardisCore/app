...
use Ecommerce\Catalog\Model\Category\Command\UpdateCategory;
...
/**
 * Validates the CommandUpdateCategory command DTO graph.
 *
 ...
 */
class ValidateUpdateCategory extends EcommerceContext
{
    /**
     * Validates the command DTO.
     *
     * @param CommandUpdateCategory $dto Command DTO
     * @throws ValidationException If validation fails
     * @throws JsonException
     * @throws Throwable
     */
    public function __invoke(CommandUpdateCategory $dto): void
    {
        $registry = new ValidatorRegistry();
        $registry->register(UpdateCategory::class, ($this->handle(CategoryValidator::class))());
