...
/**
 * Query endpoint: GetCategoryById
 */
class GetCategoryByIdHandler extends EcommerceContext
{
    /**
    ...
    {
        /** @var QueryCategoryById $categoryById */
        $categoryById = $this->payload();

        /** @var array<int, array<string, mixed>> $result */
        $result = $this->handle(CategoryRepository::class)->getCategoryById($categoryById, false);
