...
/**
 * Root query class for Category (ByIds variant).
 *
 * Loads the root entity. Follow-up queries are in QueryCategoryAdditions.
 * Generated code - do not modify directly.
 */
class QueryCategoryByIds extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(CategoryByIdsQuery $query): array
    {
        $this->container['category'] = $this->load(
            $this->category($query->ids)
        );
     ...
     * @throws Throwable
     */
    protected function category(array $ids): DbQueryBuilderInterface
    {
