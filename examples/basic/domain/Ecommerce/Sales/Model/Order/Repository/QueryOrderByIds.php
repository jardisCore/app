...
/**
 * Root query class for Order (ByIds variant).
 *
 * Loads the root entity. Follow-up queries are in QueryOrderAdditions.
 * Generated code - do not modify directly.
 */
class QueryOrderByIds extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(OrderByIdsQuery $query): array
    {
        $this->container['order'] = $this->load(
            $this->order($query->ids)
        );
     ...
     * @throws Throwable
     */
    protected function order(array $ids): DbQueryBuilderInterface
    {
