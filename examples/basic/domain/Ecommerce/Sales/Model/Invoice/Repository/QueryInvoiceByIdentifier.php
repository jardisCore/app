...
/**
 * Root query class for Invoice (ByIdentifier variant).
 *
 * Loads the root entity. Follow-up queries are in QueryInvoiceAdditions.
 * Generated code - do not modify directly.
 */
class QueryInvoiceByIdentifier extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(InvoiceByIdentifierQuery $query): array
    {
        $this->container['invoice'] = $this->load(
            $this->invoice($query->identifier)
        );
     ...
     * @throws Throwable
     */
    protected function invoice(string $identifier): DbQueryBuilderInterface
    {
