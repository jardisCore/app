...
/**
 * Root query class for Invoice (ById variant).
 *
 * Loads the root entity. Follow-up queries are in QueryInvoiceAdditions.
 * Generated code - do not modify directly.
 */
class QueryInvoiceById extends EcommerceContext
{
     ...
     * @throws Throwable
     */
    public function __invoke(InvoiceByIdQuery $query): array
    {
        $this->container['invoice'] = $this->load(
            $this->invoice($query->id)
        );
     ...
     * @throws Throwable
     */
    protected function invoice(int $id): DbQueryBuilderInterface
    {
