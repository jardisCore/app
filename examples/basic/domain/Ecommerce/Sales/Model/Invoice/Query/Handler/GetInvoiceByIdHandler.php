...
namespace Ecommerce\Sales\Model\Invoice\Query\Handler;

use Ecommerce\EcommerceContext;
use Ecommerce\Response\DomainResponseTransformer;
use Ecommerce\Sales\Model\Invoice\Query\Response\InvoiceResponse;
...
/**
 * Query endpoint: GetInvoiceById
 */
class GetInvoiceByIdHandler extends EcommerceContext
{
    /**
    ...
    {
        /** @var QueryInvoiceById $invoiceById */
        $invoiceById = $this->payload();

        /** @var array<int, array<string, mixed>> $result */
        $result = $this->handle(InvoiceRepository::class)->getInvoiceById($invoiceById, false);
