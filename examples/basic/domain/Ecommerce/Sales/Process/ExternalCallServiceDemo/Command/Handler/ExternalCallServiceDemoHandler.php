...
namespace Ecommerce\Sales\Process\ExternalCallServiceDemo\Command\Handler;
...
use Ecommerce\Sales\Process\ExternalCallServiceDemo\Command\Handler\Action\CallPricingApiBc;
use Ecommerce\Sales\Process\ExternalCallServiceDemo\Command\Handler\Action\CallPricingApiDomain;
use Ecommerce\Sales\Process\ExternalCallServiceDemo\Command\Handler\Action\CallPricingApiProcess;
use Ecommerce\Sales\Process\ExternalCallServiceDemo\Command\Handler\Action\ExternalCallServiceDemoFinalize;
use Exception;
...
/**
 * Workflow orchestrator for ExternalCallServiceDemoHandler.
 *
 ...
 */
final class ExternalCallServiceDemoHandler extends EcommerceContext
{
    /**
     * @throws Exception
     * @throws Throwable
    ...
    private function config(): WorkflowConfigInterface
    {
        return (new WorkflowConfig())
            ->addNode(CallPricingApiProcess::class, [
                WorkflowResult::ON_SUCCESS => CallPricingApiBc::class,
                WorkflowResult::ON_FAIL => ExternalCallServiceDemoFinalize::class,
            ])
            ->addNode(CallPricingApiBc::class, [
                WorkflowResult::ON_SUCCESS => CallPricingApiDomain::class,
                WorkflowResult::ON_FAIL => ExternalCallServiceDemoFinalize::class,
            ])
            ->addNode(ExternalCallServiceDemoFinalize::class, [])
            ->addNode(CallPricingApiDomain::class, [
                WorkflowResult::ON_SUCCESS => ExternalCallServiceDemoFinalize::class,
                WorkflowResult::ON_FAIL => ExternalCallServiceDemoFinalize::class,
            ]);
    }
}
