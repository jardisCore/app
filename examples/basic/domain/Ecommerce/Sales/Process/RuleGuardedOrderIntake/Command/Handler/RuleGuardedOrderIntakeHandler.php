...
namespace Ecommerce\Sales\Process\RuleGuardedOrderIntake\Command\Handler;

use Ecommerce\EcommerceContext;
use Ecommerce\Response\DomainResponseTransformer;
use Ecommerce\Sales\Process\RuleGuardedOrderIntake\Command\Handler\Action\CheckOrderEligibility;
use Ecommerce\Sales\Process\RuleGuardedOrderIntake\Command\Handler\Action\OrderIneligibleStub;
use Ecommerce\Sales\Process\RuleGuardedOrderIntake\Command\Handler\Action\OrderRejectedStub;
use Ecommerce\Sales\Process\RuleGuardedOrderIntake\Command\Handler\Action\PlaceOrder;
...
/**
 * Workflow orchestrator for RuleGuardedOrderIntakeHandler.
 *
 ...
 */
final class RuleGuardedOrderIntakeHandler extends EcommerceContext
{
    /**
     * @throws Exception
     * @throws Throwable
    ...
    private function config(): WorkflowConfigInterface
    {
        return (new WorkflowConfig())
            ->addNode(CheckOrderEligibility::class, [
                WorkflowResult::ON_SUCCESS => PlaceOrder::class,
                WorkflowResult::ON_FAIL => OrderIneligibleStub::class,
            ])
            ->addNode(PlaceOrder::class, [
                WorkflowResult::ON_FAIL => OrderRejectedStub::class,
            ])
            ->addNode(OrderIneligibleStub::class, [])
            ->addNode(OrderRejectedStub::class, []);
    }
}
